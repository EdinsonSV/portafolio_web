            ...
            <nav class="flex flex-col justify-between items-center lg:flex-row max-w-7xl m-auto w-full">
                ...
                <div class="lg:flex hidden">
                    <ul class="flex gap-8 text-xs font-bold">
                        ...
                        <li>
                            <a href="#experiencia" class="text-white hover:text-gray-400">EXPERIENCIA</a>
                        </li>
                        <li>
                            <a href="#proyectos" class="text-white hover:text-gray-400">PROYECTOS</a>
                        </li>
                        <li>
                            <a href="#contacto" class="text-white hover:text-gray-400">CONTACTO</a>
                        </li>
                    </ul>
                </div>
